codeunit 51000 WH_LabelManagement
{
    ...
    procedure GetLabelsForUserLanguage(var TempPowerAppsLabels: Record WH_Labels temporary; languageFilter: Text)
    var
    ...
    procedure GetReportLabels(var TempPowerAppsLabels: Record WH_Labels temporary)
    begin
    ...
    procedure OnAfterGeneratePowerAppsLabels(var PowerBIReportLabels: Record WH_Labels temporary)
    begin
    end;
}
